    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <block v-if="item.header.length > 5">
              {{ item.header.substr(0, 4) }}...
            </block>
            <block v-else>
              {{ item.header }}
            </block>
        ...
        >
          ...
          >
            ...
            >
              ...
              <!-- <text class="pet-all" v-if="content == '全部宠物'"
                >包括已删除的和宠物信息错误的</text
              > -->
            </text>
            <!-- <text
              v-if="
                contentActiveIndexList[headerActiveIndex]['index'] === zIndex &&
                dropOver
              "
            ...
            /> -->
            <!-- <view
              class="wyb-drop-down-line"
              v-if="zIndex !== options[headerActiveIndex].contents.length - 1"
            /> -->
          </view>
        </view>
      </scroll-view>
  ...
  methods: {
    ...
    onContentItemsTap(index) {
      ...
      let event = {
        ...
        petId: this.options[this.headerActiveIndex]["petId"]
          ? this.options[this.headerActiveIndex]["petId"][index]
          : "",
      };
