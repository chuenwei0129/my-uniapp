<template>
  <view class="page" :style="{
        paddingTop: `${statusBarHeight + 45 }px`,
      }">
    <!-- 标题 -->
    <!-- #ifdef H5 -->
    <view
    ...
    <scroll-view
      ...
      enable-flex="true"
      :style="{ height: `calc( 100vh - ${statusBarHeight + 45}px)`}"
    >
      <sheetsList :isPageShow="isPageShow" :petId="petId"></sheetsList>
    </scroll-view>
...
import { getTypeModule } from "@/pagesB/api/index";
