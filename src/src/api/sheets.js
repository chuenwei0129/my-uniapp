...
export const pinganConfirmRequest = (data = {}) => {
  return request({
    url: `cpp-user-management/v1/thirdParty/authorization/isAuthorization`,
    method: "POST",
    data,
    gw: false,
    loading: false,
...
export const userConfirmRequest = (data = {}) => {
  return request({
    url: `cpp-user-management/v1/thirdParty/authorization/update`,
    method: "POST",
    data,
    gw: false,
    loading: false,
...
export const getPrescriptionDetail = (data = {}) => {
  return request({
    url: `pet-medical-inquiry/v1/doctor/diagnostic/${data.id}`,
    method: "GET",
    data,
    gw: false,
    loading: false,
