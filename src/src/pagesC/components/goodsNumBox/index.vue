<template>
  <view class="goods-num-box">
    <u-number-box v-model="value" @change="onValueChange" :min="min" :max="max">
      <template #minus>
        <view :class="['minus', isMinusDisabled ? 'disable' : '']"> </view>
      </template>
      <template #input>
        <text
          class="input"
      ...
      <template #plus>
        <view :class="['plus', isPlusDisabled ? 'disable' : '']"> </view>
      </template>
    </u-number-box>
