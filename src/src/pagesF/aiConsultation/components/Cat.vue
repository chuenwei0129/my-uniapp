...
.page-wrapper {
  margin: 0 auto;
  position: relative;
  // background-image: url("https://frontend-cdn.chongpangpang.com/image/medical-mp/aiConsultation/cat.png");
  background-image: url("//frontend-cdn.chongpangpang.com/image/medical-mp/aiConsultation/catLine.png");
